...
function TeamMain() {
	return (
		<div>
			...
			<Team_template
				team_name='Marketing and Sponsorship'
				coordsarray={images.spons_CoordsImages}
			/>
			<Team_template
				team_name='Media and Public Relations'
				coordsarray={images.mpr_CoordsImages}
			/>
			<Team_template
				team_name='Creatives And Designs'
				coordsarray={images.cnd_CoordsImages}
			/>
			<Team_template
				team_name='Workshop Committee'
				coordsarray={images.workshop_CoordsImages}
			/>
			...
			<Team_template
				team_name='Hospitality Committee'
				coordsarray={images.hospi_CoordsImages}
			/>
		</div>
	);
}
